...
m <- 10000
num <- double (n)
ver <- double (n)  // массив вероятностей
ver_sum <- double (n)
mas <- double (m)
m300 <- double (300)
m30 <- double (30)

// возвращает значение в зависимости от значения распределения 
...
// создаём второй массив вероятностей
while (k > 0)
{
...
// выборки для 300 с повторениями и 30 без повторений 
for (i in 1:300)
{
